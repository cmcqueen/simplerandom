...
class MWC1Test(CongTest):
    ...
    MIX_MILLION_STATE = (1296273776, 751019182)
    MIX_MILLION_RESULT = 560871203


class KISS2Test(CongTest):
    RNG_CLASS = sri.KISS2
    RNG_SEEDS = 4
    MILLION_RESULT = 1034560637
    MWC64_CYCLE_LEN = 698769069 * 2**32 // 2 - 1
    RNG_CYCLE_LEN = MWC64_CYCLE_LEN * CongTest.RNG_CYCLE_LEN * SHR3Test.RNG_CYCLE_LEN
    MIX_MILLION_STATE = ((263629581, 980941302), (662840047,), (2563538272,))
    MIX_MILLION_RESULT = 2037441463
...
class MWC2Test(KISS2Test):
    ...
    MILLION_RESULT = 847931684
    MIX_MILLION_STATE = (1557895882, 538087390)
    MIX_MILLION_RESULT = 2704875715
...
class KISSTest(CongTest):
    ...
    MIX_MILLION_STATE = ((955942172, 1130982425), (2359564668,), (1925690336,))
    MIX_MILLION_RESULT = 3033435879
